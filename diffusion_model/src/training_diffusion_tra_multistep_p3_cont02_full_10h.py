...
from turbpred.trainer_diffusion_tra_fullcont import TrainerDiffusion, TesterDiffusion
...
if __name__ == "__main__":
    ...
    modelName = "2D_Tra/128_acdm-r20_tra_multistep_p3_cont02_full_10h"


    # Multi-step setting
    # C = 2 conditioning frames
    # C = 3 history frames, P = 3 predicted future frames per diffusion call
    historySteps = 3
    futureSteps = 3
    ...
    # Explicit multi-step attributes used by model.py / trainer_diffusion.py.
    ...
    print("TRA multi-step configuration:")
    print("  historySteps =", p_d.historySteps)
    print("  futureSteps  =", p_d.futureSteps)
    print("  multiStep    =", p_d.multiStep)
    print("  sequenceLength =", p_d.sequenceLength)
