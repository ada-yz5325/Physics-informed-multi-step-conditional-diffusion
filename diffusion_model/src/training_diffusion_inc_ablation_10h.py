...
if __name__ == "__main__":
    ...
    modelName = os.environ.get(
        "MODEL_NAME",
        "2D_Inc/128_acdm-r20_puv_phys_ablation_all_10h"
    )
    ...
    p_l.regDiv = float(os.environ.get("REG_DIV", "0.01"))
    p_l.regVort = float(os.environ.get("REG_VORT", "0.01"))

    print("Ablation loss setting:")
    print("  REG_DIV =", p_l.regDiv)
    print("  REG_VORT =", p_l.regVort)
